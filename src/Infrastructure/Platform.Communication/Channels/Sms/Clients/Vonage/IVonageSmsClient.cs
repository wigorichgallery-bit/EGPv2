...
/// <summary>
/// Defines the contract for communicating with the Vonage SMS API.
/// </summary>
internal interface IVonageSmsClient
{
    /// <summary>
    /// Sends an SMS message through the Vonage API.
    /// </summary>
    ...
    /// vendor delivery information returned by Vonage.
    /// </returns>
    /// <exception cref="ArgumentException">
    /// Thrown when <paramref name="recipient"/> or
    /// <paramref name="message"/> is null, empty,
