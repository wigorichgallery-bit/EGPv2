...
/// </summary>
public sealed class WhatsAppAuthenticationChallengeSenderTests
{
    ...
    public void Constructor_ShouldThrowArgumentNullException_WhenFormatterIsNull()
    {
        // Act
        Action act =
            () => new WhatsAppAuthenticationChallengeSender(
                null!);
    ...
    public async Task SendAsync_ShouldThrowArgumentNullException_WhenRequestIsNull()
    {
        // Arrange
        var formatter =
            new Mock<IAuthenticationChallengeWhatsAppFormatter>();
    ...
    public async Task SendAsync_ShouldInvokeFormatter()
    {
        ...
        var message =
            new AuthenticationWhatsAppMessage(
                "+628123456789",
                "Body");
    ...
    /// <summary>
    /// Verifies sending with a cancellation token follows
    /// the current production behavior.
    /// </summary>
    /// <remarks>
    /// The current implementation cannot observe the
    /// cancellation token because
    /// <c>SendCoreAsync</c> is a private static method
    /// that always throws
