...
/// <summary>
/// Contains unit tests for <see cref="VonageSmsProvider"/>.
/// </summary>
public sealed class VonageSmsProviderTests
{
    ...
    {
        _client = Substitute.For<IVonageSmsClient>();
        _logger = Substitute.For<ILogger<VonageSmsProvider>>();
    }
    ...
    {
        // Arrange
        VonageSmsProvider provider = new(
            _client,
            _logger);
    ...
    public async Task SendAsync_Should_ReturnFailure_When_ClientThrowsException()
    {
        ...
        _client
            .SendMessageAsync(
                ...
                Arg.Any<CancellationToken>())
            .Returns<Task<VendorDeliveryResult>>(
                _ => throw new InvalidOperationException("Vonage failure."));
        ...
        // Assert
        result.Succeeded.Should().BeFalse();
        result.ErrorMessage.Should().Be("Vonage failure.");
    }

    /// <summary>
    /// Verifies that SendAsync invokes the client
    ...
    public async Task SendAsync_Should_InvokeClientForEachRecipient_When_MultipleRecipientsExist()
    {
        ...
        SmsMessage message =
            SmsMessageTestData.CreateMultipleRecipients();
