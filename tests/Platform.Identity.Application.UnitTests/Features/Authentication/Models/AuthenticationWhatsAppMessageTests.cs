...
/// <summary>
/// Contains unit tests for <see cref="AuthenticationWhatsAppMessage"/>.
/// </summary>
public sealed class AuthenticationWhatsAppMessageTests
{
    /// <summary>
    ...
    public void Constructor_Should_Assign_All_Properties()
    {
        ...
        // Act
        var message = new AuthenticationWhatsAppMessage(
            recipient,
            body);
    ...
    {
        // Arrange
        var left = new AuthenticationWhatsAppMessage(
            "+6281234567890",
            "Your verification code is 123456.");

        var right = new AuthenticationWhatsAppMessage(
            "+6281234567890",
            "Your verification code is 123456.");
    ...
    public void ToString_Should_Contain_Property_Names()
    {
        ...
        // Assert
        text.Should().Contain(nameof(AuthenticationWhatsAppMessage.Recipient));
        text.Should().Contain(nameof(AuthenticationWhatsAppMessage.Body));
    }
}