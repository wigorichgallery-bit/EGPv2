...
/// <summary>
/// Unit tests for <see cref="VerifyEmailUseCase"/>.
/// </summary>
public sealed class VerifyEmailUseCaseTests
{
    ...
    /// </summary>
    private VerifyEmailUseCase CreateSut(
    ...
    /// </summary>
    private static VerifyEmailCommand CreateCommand()
    {
    ...
    /// to all asynchronous collaborators.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Verifies email is successfully verified.
    /// </summary>
    [Fact]
    public async Task ExecuteAsync_Should_Return_Success_When_Email_Is_Verified()
    {
        // Arrange
    ...
    /// <summary>
    /// Verifies already verified email
    /// still returns success.
    /// </summary>
    [Fact]
    public async Task ExecuteAsync_Should_Return_Success_When_Email_Is_Already_Verified()
    {
        // Arrange
